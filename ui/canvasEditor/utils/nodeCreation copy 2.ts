...
export const createNode = (
  ...
  let positionAsXYPosition = setPosition(position.x, position.y);

  // Check if the position is occupied and adjust if necessary
  while (
    isPositionOccupied(positionAsXYPosition, existingNodes, nodeDimension)
  ) {
    positionAsXYPosition = setPosition(
      positionAsXYPosition.x + nodeDimension.width,
