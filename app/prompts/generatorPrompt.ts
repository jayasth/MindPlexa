...
- trictly Use the format "NodeID[NodeTitle::NodeDescription]" for each node, where the title is a key point and the description elaborates on it (your response will be parsed into a json object and visually represented as reactFlow nodes to the users)
- Ensure the parent node always has a meaningful title and description, user can enter anything they want
- Connect nodes in a coherent flow that makes sense for the topic
- Avoid any special characters or double quotes in the node text that could break the Mermaid syntax
